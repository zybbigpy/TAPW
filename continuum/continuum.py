...
def _set_moire(n_moire: int) -> tuple:
    ...
    return (m_unitvec_1, m_unitvec_2, m_g_unitvec_1, m_g_unitvec_2, m_gamma_vec, m_k1_vec, m_k2_vec, m_m_vec,
            rt_mtrx_half)
...
def _make_hamk(k, kpt1, kpt2, m_g_unitvec_1, m_g_unitvec_2, glist, rt_mtrx_half, tmat, valley):
    ...
    hamk = np.block([[h1mat, tmat], [np.conj(np.transpose(tmat)), h2mat]])
...
def cont_solver(n_moire, n_g, n_k, valley):
    ...
    (m_unitvec_1, m_unitvec_2, m_g_unitvec_1, m_g_unitvec_2, m_gamma_vec, m_k1_vec, m_k2_vec, m_m_vec,
     rt_mtrx_half) = _set_moire(n_moire)
    ...
    for k in kmesh:
        ...
        count += 1
        hamk = _make_hamk(k, kpt1, kpt2, m_g_unitvec_1, m_g_unitvec_2, glist, rt_mtrx_half, tmat, valley)

...
def tightbinding_plot_sparsetb(n_moire:int, n_g:int, n_k:int, band:int, datatype:str, pathname:str, name="", mu=False):

    emesh, _, kline, _, _ = mtb.tightbinding_solver(n_moire, n_g, n_k, datatype, '0', disp=True, fulltb=True, sparse=True)
    n_band = emesh[0].shape[0]
...
def tightbinding_plot_fulltb(n_moire:int, n_g:int, n_k:int, band:int, datatype:str, pathname:str, name="", mu=False):
    ...
    emesh, _, kline, _, _ = mtb.tightbinding_solver(n_moire, n_g, n_k, datatype, '0', disp=True, fulltb=True, sparse=False)
    n_band = emesh[0].shape[0]
...
def sparsetb_sep_valley_cmp(n_moire:int, n_g:int, n_k:int, bandsparse:int, bandpw: int, datatype:str, pathname:str, name=""):
    emesh, _, kline, _, _ = mtb.tightbinding_solver(n_moire, n_g, n_k, datatype, '+1', disp=True, fulltb=False)
    n_band = emesh[0].shape[0]
...
def sparsetb_comb_valley_cmp(n_moire:int, n_g:int, n_k:int, bandsparse:int, bandpw: int, datatype:str, pathname:str, name=""):
